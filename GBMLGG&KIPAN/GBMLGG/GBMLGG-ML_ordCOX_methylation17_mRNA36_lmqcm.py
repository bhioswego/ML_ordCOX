#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index= 0.8237124337065409  ？ remove log_var[i] seems as no difference. 0.8236417206835592
 #only: data_mRNA: 0.8087919858573954                                                            0.8088391278727166
 #only: data_methylation:0.8149440188568061                                                      0.8152740129640542
"""
...
#    plt.show() 
    ...
    plt.savefig('GBMLGG_Lambda Curves without penalty term.jpg', dpi=300) #指定分辨率保存
    plt.show()
...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    plt.savefig('GBMLGG_Loss Curves without penalty term.jpg', dpi=300) #指定分辨率保存
    plt.show()
    
    
    np.savetxt("GBMLGG_methylation_mRNA_without_penalty_term_ml_ordCOX_20210107.csv",hist.history['loss'], delimiter=",")
...
np.savetxt("GBMLGG_prediction1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv", ypred, delimiter=",")
np.savetxt("GBMLGG_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv", time_new, delimiter=",")
np.savetxt("GBMLGG_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv", status_new, delimiter=",")
np.savetxt("GBMLGG_ypred_train_median1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv", ypred_train, delimiter=",")

df = pd.read_csv("GBMLGG_prediction1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv",header=None)    
month=np.asarray(pd.read_csv("GBMLGG_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv",header=None)) 
status=np.asarray(pd.read_csv("GBMLGG_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv",header=None)) 
...
print("GBMLGG_methylation17_mRNA36_lmqcm_lr_backend2233_without_penalty_term3_NO_PPPPplot_new_dataset_20210105_3333_0.8237124337065409.py") 
print("GBMLGG:dataX=data_rna+methylation:",c_indices_mlp)
#print("GBMLGG:dataX=data_rna:",c_indices_mlp)
#print("GBMLGG:dataX=data_methylation:",c_indices_mlp)
