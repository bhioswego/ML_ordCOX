#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.7725281862541009 ？ remove log_var[i] seems as no difference.
"""
...
#    plt.show()
    ...
    np.savetxt("KIPAN_hist.history['loss1000_ml_ordCOX20201220']_without_penalty_term_only_auxiliary_loss.csv",hist.history['loss'], delimiter=",")
...
np.savetxt("KIPAN_prediction1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv", ypred, delimiter=",")
np.savetxt("KIPAN_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv", time_new, delimiter=",")
np.savetxt("KIPAN_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv", status_new, delimiter=",")
np.savetxt("KIPAN_ypred_train_median1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv", ypred_train, delimiter=",")

df = pd.read_csv("KIPAN_prediction1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv",header=None)    
month=np.asarray(pd.read_csv("KIPAN_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv",header=None)) 
status=np.asarray(pd.read_csv("KIPAN_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_AUXlloss.csv",header=None)) 
...
print("KIPAN_methylation_mRNA_lmqcm_lr_backend2233_only_auxiliary_loss20210123_.py") 
print("KIPAN only_AUXloss:dataX=data_rna+methylation:",c_indices_mlp)
