...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    ...
    np.savetxt("GBLGG_hist.history['loss1000_ml_ordCOX20201220']_without_penalty_term_only_main_loss.csv",hist.history['loss'], delimiter=",")
...
np.savetxt("GBLGG_prediction1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv", ypred, delimiter=",")
np.savetxt("GBLGG_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv", time_new, delimiter=",")
np.savetxt("GBLGG_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv", status_new, delimiter=",")
np.savetxt("GBLGG_ypred_train_median1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv", ypred_train, delimiter=",")

df = pd.read_csv("GBLGG_prediction1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv",header=None)    
month=np.asarray(pd.read_csv("GBLGG_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv",header=None)) 
status=np.asarray(pd.read_csv("GBLGG_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term_only_mainloss.csv",header=None)) 
...
np.save("c_indices_without penalty term_only_mainloss",c_indices_mlp) 
print("GBLGG_methylation_mRNA_lmqcm_lr_backend2233_only_main_loss20210106.py") 
print("GBLGG only_main:dataX=data_rna+methylation:",c_indices_mlp)
data_a=np.load('c_indices_without penalty term_only_mainloss.npy')
aa=0